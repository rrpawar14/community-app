        ...
        ResourceFactoryProvider: function () {
            ...
            this.$get = ['$resource', '$rootScope', function (resource, $rootScope) {
                ...
                return {
                    ...
                    savingsAccountHoldTransactionResource: defineResource(apiVer + "/savingsaccounts/:savingsId/transactions", {savingsId: '@savingsId'}, {
                        getHoldTransactions: {method: 'GET', params:{transactionType : 'AMOUNT_HOLD'}, isArray: true}
                    }),
